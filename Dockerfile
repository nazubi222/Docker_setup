...
RUN git clone --recursive https://github.com/openshwprojects/OpenBK7231N \
    ...
    && cp -r OpenBK7231T_App/ OpenBK7231N/apps/OpenBK7231N_App \
    && cp -r OpenBK7231T_App/ OpenBK7231T/apps/OpenBK7231T_App

COPY ./script/* /app/OpenBK7231N/
COPY ./script/* /app/OpenBK7231T/

RUN chmod +x /app/OpenBK7231N/*
RUN chmod +x /app/OpenBK7231T/*
